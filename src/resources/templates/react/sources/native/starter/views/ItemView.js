...
/**
 * Starter Ignite Auto-Generated Item 
 * 
 * Data Entry View
 * 
 */
  ...
  render() {
    ...
    return (
      ...
      <Text>Update Item</Text>
        ...
        <Form model=".Item" onSubmit={(vals) => alert(JSON.stringify(vals))}>
        <View style={styles.row}>
			<Text style={styles.titleFormHeader}> : doggie	</Text>
			<Control.TextInput
...
// module.exports = connect(mapStateToProps)(ItemView);

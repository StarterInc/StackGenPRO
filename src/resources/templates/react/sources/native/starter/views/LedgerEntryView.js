...
/**
 * Starter Ignite Auto-Generated LedgerEntry 
 * 
 * Data Entry View
 * 
 */

/// BEGIN LedgerEntry_upper
...
// / END LedgerEntry_upper

class LedgerEntryView extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Text>Update LedgerEntry</Text>
        
        <Form model=".LedgerEntry" onSubmit={(vals) => alert(JSON.stringify(vals))}>
...
// module.exports = connect(mapStateToProps)(LedgerEntryView);
module.exports = LedgerEntryView

...
/**
 * Starter Ignite Auto-Generated AuditLog 
 * 
 * Data Entry View
 * 
 */

/// BEGIN AuditLog_upper
...
class AuditLogView extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Text>Update AuditLog</Text>
        
        <Form model=".AuditLog" onSubmit={(vals) => alert(JSON.stringify(vals))}>
        ...
        <View style={styles.row}>
			<Text style={styles.titleFormHeader}> : userId:1000	</Text>
			<Control.TextInput
			    style={styles.formInput}
				model="."  
	        	validators=
...
// module.exports = connect(mapStateToProps)(AuditLogView);
module.exports = AuditLogView

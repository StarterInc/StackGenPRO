...
/**
 * Starter Ignite Auto-Generated Csat 
 * 
 * Data Entry View
 * 
 */
...
class CsatView extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Text>Update Csat</Text>
        
        <Form model=".Csat" onSubmit={(vals) => alert(JSON.stringify(vals))}>
...
// module.exports = connect(mapStateToProps)(CsatView);
module.exports = CsatView

...
/**
 * Starter Ignite Auto-Generated Trade 
 * 
 * Data Entry View
 * 
 */
...
class TradeView extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Text>Update Trade</Text>
        
        <Form model=".Trade" onSubmit={(vals) => alert(JSON.stringify(vals))}>
        <View style={styles.row}>
			<Text style={styles.titleFormHeader}> : Litespeed	</Text>
			<Control.TextInput
        ...
        <View style={styles.row}>
			<Text style={styles.titleFormHeader}> : MARKET	</Text>
			<Control.TextInput
			    style={styles.formInput}
				model="."  
	        	validators=
...
// module.exports = connect(mapStateToProps)(TradeView);

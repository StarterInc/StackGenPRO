...
/**
 * Starter Ignite Auto-Generated ModelApiResponse 
 * 
 * Data Entry View
 * 
 */

/// BEGIN ModelApiResponse_upper
...
// / END ModelApiResponse_upper

class ModelApiResponseView extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Text>Update ModelApiResponse</Text>
        
        <Form model=".ModelApiResponse" onSubmit={(vals) => alert(JSON.stringify(vals))}>
...
// module.exports = connect(mapStateToProps)(ModelApiResponseView);
module.exports = ModelApiResponseView

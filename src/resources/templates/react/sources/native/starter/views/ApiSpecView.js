...
/**
 * Starter Ignite Auto-Generated ApiSpec 
 * 
 * Data Entry View
 * 
 */
...
class ApiSpecView extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Text>Update ApiSpec</Text>
        
        <Form model=".ApiSpec" onSubmit={(vals) => alert(JSON.stringify(vals))}>
...
// module.exports = connect(mapStateToProps)(ApiSpecView);
module.exports = ApiSpecView

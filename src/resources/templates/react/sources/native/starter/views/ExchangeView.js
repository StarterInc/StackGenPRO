...
/**
 * Starter Ignite Auto-Generated Exchange 
 * 
 * Data Entry View
 * 
 */

/// BEGIN Exchange_upper
...
class ExchangeView extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Text>Update Exchange</Text>
        
        <Form model=".Exchange" onSubmit={(vals) => alert(JSON.stringify(vals))}>
        <View style={styles.row}>
			<Text style={styles.titleFormHeader}> : Bitfinex	</Text>
			<Control.TextInput
        ...
        <View style={styles.row}>
			<Text style={styles.titleFormHeader}> : CAN	</Text>
			<Control.TextInput
			    style={styles.formInput}
				model="."  
	        	validators=
        ...
        <View style={styles.row}>
			<Text style={styles.titleFormHeader}> : GDX	</Text>
			<Control.TextInput
			    style={styles.formInput}
				model="."  
	        	validators=
...
// module.exports = connect(mapStateToProps)(ExchangeView);

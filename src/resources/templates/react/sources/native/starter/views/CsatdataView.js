...
/**
 * Starter Ignite Auto-Generated Csatdata 
 * 
 * Data Entry View
 * 
 */

/// BEGIN Csatdata_upper
...
class CsatdataView extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Text>Update Csatdata</Text>
        
        <Form model=".Csatdata" onSubmit={(vals) => alert(JSON.stringify(vals))}>
...
// module.exports = connect(mapStateToProps)(CsatdataView);
module.exports = CsatdataView

...
@Size(min=10) 
  ...
  **/
  ...
  public User addAuthoritiesItem(String authoritiesItem) {
   ...
   /**
   * Spring Security User representation of the granted authority (or &lt;code&gt;null&lt;/code&gt; if the granted authority cannot be expressed as a &lt;code&gt;String&lt;/code&gt; with sufficient precision).
   * @return authorities
  **/
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(firstName, lastName, governmentId, userName, password, fingerprint, homePage, email, social, credentialNonExpired, accountEnabled, accountNonLocked, accountNonExpired, authorities, keyVersion, keySpec, ownerId, createdDate, modifiedDate, id);
  }

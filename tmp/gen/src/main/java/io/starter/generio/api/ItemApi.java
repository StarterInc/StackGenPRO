...
import io.starter.generio.model.Item;
...
public interface ItemApi {
    ...
    ItemApiDelegate getDelegate();

    @ApiOperation(value = "Delete an Item from the system", nickname = "delete", notes = "Starter Ignite Auto Generated Item:delete", authorizations = {
    ...
    @ApiOperation(value = "Insert a new Item into the system", nickname = "insert", notes = "Starter Ignite Auto Generated Item:insert", response = Item.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Results fetched OK", response = Item.class) })
    @RequestMapping(value = "/Item/{param}",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<Item> insert(@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Item param) {
    ...
    @RequestMapping(value = "/Item/list/{searchparam}",
    ...
    @ApiOperation(value = "Load a Item from the system", nickname = "load", notes = "Starter Ignite Auto Generated Item:load", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    @ApiOperation(value = "Update a Item in the system", nickname = "update", notes = "Starter Ignite Auto Generated Item:update", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    default ResponseEntity<Object> update(@Min(0)@ApiParam(value = "Retreive a single result by ID",required=true) @PathVariable("param") Integer param,@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Item param2) {

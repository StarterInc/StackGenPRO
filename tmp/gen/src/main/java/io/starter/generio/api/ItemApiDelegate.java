...
public interface ItemApiDelegate {
    ...
    Logger log = LoggerFactory.getLogger(ItemApiDelegate.class);
    ...
    public List<ItemApiDelegate> list();
    
    public ItemApiDelegate load();
    ...
    default ResponseEntity<Void> delete( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method ItemApi.delete: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default ItemApi interface so no example is generated");
        }
     ...
     * @see ItemApi#insert
     */
    default ResponseEntity<Item> insert( Item  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				if (ret != null) {
					if (ret instanceof List) {
						return 
						(ResponseEntity<Item>) getResponse((List<?>) ret);
					} else {
						return 
						(ResponseEntity<Item>) getResponse((Object) ret);
					}
				} else {
					return new ResponseEntity<>(HttpStatus.NOT_FOUND);
				}
			} catch (Exception e) {
				log.error("Failure running method ItemApi.insert: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
    ...
    default ResponseEntity<List<Object>> list( String  searchparam) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method ItemApi.list: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> load( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method ItemApi.load: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> update( Integer  param,
        ...
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method ItemApi.update: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
	...
	*/
	...
	default ResponseEntity<?> getResponse(Object ret) throws JsonParseException, JsonMappingException, IOException {
		...
		JSONObject job = new JSONObject(((ItemApiDelegate)ret).getBean());
		return new ResponseEntity<>(getObjectMapper().readValue(job.toString(), Item.class), HttpStatus.OK);
	}

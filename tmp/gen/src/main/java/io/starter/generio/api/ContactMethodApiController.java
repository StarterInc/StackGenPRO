 ...
 */
public class ContactMethodApiController implements ContactMethodApi {

    
    @org.springframework.beans.factory.annotation.Autowired
    private ContactMethodApiDelegate delegate = null;

	/**
	* No-Args Constructor for classloading.
	*/
	public ContactMethodApiController() {
		// do not use
    }
    
    @org.springframework.beans.factory.annotation.Autowired
    public ContactMethodApiController(ContactMethodApiDelegate delegate) {
        this.delegate = delegate;
    }

    @Override
    public ContactMethodApiDelegate getDelegate() {
        return delegate;
    }
}

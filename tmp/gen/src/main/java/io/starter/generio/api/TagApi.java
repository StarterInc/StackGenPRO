...
public interface TagApi {
    ...
    TagApiDelegate getDelegate();

    @ApiOperation(value = "Delete an Tag from the system", nickname = "delete", notes = "Starter Ignite Auto Generated Tag:delete", authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = {  })
    @RequestMapping(value = "/Tag/{param}",
    ...
    @ApiOperation(value = "Insert a new Tag into the system", nickname = "insert", notes = "Starter Ignite Auto Generated Tag:insert", response = Tag.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Results fetched OK", response = Tag.class) })
    @RequestMapping(value = "/Tag/{param}",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<Tag> insert(@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Tag param) {
    ...
    @RequestMapping(value = "/Tag/list/{searchparam}",
    ...
    @ApiOperation(value = "Load a Tag from the system", nickname = "load", notes = "Starter Ignite Auto Generated Tag:load", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    @ApiOperation(value = "Update a Tag in the system", nickname = "update", notes = "Starter Ignite Auto Generated Tag:update", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    default ResponseEntity<Object> update(@Min(0)@ApiParam(value = "Retreive a single result by ID",required=true) @PathVariable("param") Integer param,@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Tag param2) {

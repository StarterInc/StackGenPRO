...
/**
 * A delegate to be called by the {@link WorkFlowsApiController}}.
...
@EnableWebMvc
public interface WorkFlowsApiDelegate {

    Logger log = LoggerFactory.getLogger(WorkFlowsApiDelegate.class);
    ...
    public List<WorkFlowsApiDelegate> list();
    
    public WorkFlowsApiDelegate load();
    ...
    default ResponseEntity<Void> delete( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method WorkFlowsApi.delete: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default WorkFlowsApi interface so no example is generated");
        }
     ...
     * Dispatch the request to the delegate data object method and handle response
     *
     * @see WorkFlowsApi#insert
     */
    default ResponseEntity<WorkFlows> insert( WorkFlows  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				if (ret != null) {
					if (ret instanceof List) {
						return 
						(ResponseEntity<WorkFlows>) getResponse((List<?>) ret);
					} else {
						return 
						(ResponseEntity<WorkFlows>) getResponse((Object) ret);
					}
				} else {
					return new ResponseEntity<>(HttpStatus.NOT_FOUND);
				}
			} catch (Exception e) {
				log.error("Failure running method WorkFlowsApi.insert: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
    ...
    default ResponseEntity<List<Object>> list( String  searchparam) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method WorkFlowsApi.list: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> load( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method WorkFlowsApi.load: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> update( Integer  param,
        ...
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method WorkFlowsApi.update: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
	...
	*/
	...
	default ResponseEntity<?> getResponse(Object ret) throws JsonParseException, JsonMappingException, IOException {
		...
		JSONObject job = new JSONObject(((WorkFlowsApiDelegate)ret).getBean());
		return new ResponseEntity<>(getObjectMapper().readValue(job.toString(), WorkFlows.class), HttpStatus.OK);
	}

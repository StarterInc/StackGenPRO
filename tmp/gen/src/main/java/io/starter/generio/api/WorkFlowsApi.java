...
import io.starter.generio.model.WorkFlows;
...
public interface WorkFlowsApi {
    ...
    WorkFlowsApiDelegate getDelegate();

    @ApiOperation(value = "Delete an WorkFlows from the system", nickname = "delete", notes = "Starter Ignite Auto Generated WorkFlows:delete", authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = {  })
    @RequestMapping(value = "/WorkFlows/{param}",
    ...
    @ApiOperation(value = "Insert a new WorkFlows into the system", nickname = "insert", notes = "Starter Ignite Auto Generated WorkFlows:insert", response = WorkFlows.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Results fetched OK", response = WorkFlows.class) })
    @RequestMapping(value = "/WorkFlows/{param}",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<WorkFlows> insert(@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody WorkFlows param) {
    ...
    @RequestMapping(value = "/WorkFlows/list/{searchparam}",
    ...
    @ApiOperation(value = "Load a WorkFlows from the system", nickname = "load", notes = "Starter Ignite Auto Generated WorkFlows:load", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    @ApiOperation(value = "Update a WorkFlows in the system", nickname = "update", notes = "Starter Ignite Auto Generated WorkFlows:update", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    default ResponseEntity<Object> update(@Min(0)@ApiParam(value = "Retreive a single result by ID",required=true) @PathVariable("param") Integer param,@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody WorkFlows param2) {

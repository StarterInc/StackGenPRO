...
import io.starter.generio.model.Account;
...
public interface AccountApi {
    ...
    AccountApiDelegate getDelegate();

    @ApiOperation(value = "Delete an Account from the system", nickname = "delete", notes = "Starter Ignite Auto Generated Account:delete", authorizations = {
    ...
    @ApiOperation(value = "Insert a new Account into the system", nickname = "insert", notes = "Starter Ignite Auto Generated Account:insert", response = Account.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Results fetched OK", response = Account.class) })
    @RequestMapping(value = "/Account/{param}",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<Account> insert(@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Account param) {
    ...
    @RequestMapping(value = "/Account/list/{searchparam}",
    ...
    @ApiOperation(value = "Load a Account from the system", nickname = "load", notes = "Starter Ignite Auto Generated Account:load", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    @ApiOperation(value = "Update a Account in the system", nickname = "update", notes = "Starter Ignite Auto Generated Account:update", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    default ResponseEntity<Object> update(@Min(0)@ApiParam(value = "Retreive a single result by ID",required=true) @PathVariable("param") Integer param,@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Account param2) {

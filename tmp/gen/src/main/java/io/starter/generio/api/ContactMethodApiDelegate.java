...
/**
 * A delegate to be called by the {@link ContactMethodApiController}}.
...
@EnableWebMvc
public interface ContactMethodApiDelegate {

    Logger log = LoggerFactory.getLogger(ContactMethodApiDelegate.class);
    ...
    public List<ContactMethodApiDelegate> list();
    
    public ContactMethodApiDelegate load();
    ...
    default ResponseEntity<Void> delete( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method ContactMethodApi.delete: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default ContactMethodApi interface so no example is generated");
        }
     ...
     * Dispatch the request to the delegate data object method and handle response
     *
     * @see ContactMethodApi#insert
     */
    default ResponseEntity<ContactMethod> insert( ContactMethod  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				if (ret != null) {
					if (ret instanceof List) {
						return 
						(ResponseEntity<ContactMethod>) getResponse((List<?>) ret);
					} else {
						return 
						(ResponseEntity<ContactMethod>) getResponse((Object) ret);
					}
				} else {
					return new ResponseEntity<>(HttpStatus.NOT_FOUND);
				}
			} catch (Exception e) {
				log.error("Failure running method ContactMethodApi.insert: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
    ...
    default ResponseEntity<List<Object>> list( String  searchparam) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method ContactMethodApi.list: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> load( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method ContactMethodApi.load: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> update( Integer  param,
        ...
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method ContactMethodApi.update: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
	...
	*/
	...
	default ResponseEntity<?> getResponse(Object ret) throws JsonParseException, JsonMappingException, IOException {
		...
		JSONObject job = new JSONObject(((ContactMethodApiDelegate)ret).getBean());
		return new ResponseEntity<>(getObjectMapper().readValue(job.toString(), ContactMethod.class), HttpStatus.OK);
	}

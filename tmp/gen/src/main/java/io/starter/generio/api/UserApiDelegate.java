...
public interface UserApiDelegate {
    ...
    Logger log = LoggerFactory.getLogger(UserApiDelegate.class);
    ...
    public List<UserApiDelegate> list();
    
    public UserApiDelegate load();
    ...
    default ResponseEntity<Void> delete( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method UserApi.delete: "
						+ e);
     ...
     * @see UserApi#insert
     */
    default ResponseEntity<User> insert( User  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				if (ret != null) {
					if (ret instanceof List) {
						return 
						(ResponseEntity<User>) getResponse((List<?>) ret);
					} else {
						return 
						(ResponseEntity<User>) getResponse((Object) ret);
					}
				} else {
					return new ResponseEntity<>(HttpStatus.NOT_FOUND);
				}
			} catch (Exception e) {
				log.error("Failure running method UserApi.insert: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
    ...
    default ResponseEntity<List<Object>> list( String  searchparam) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method UserApi.list: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> load( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method UserApi.load: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> update( Integer  param,
        ...
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method UserApi.update: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
	...
	*/
	...
	default ResponseEntity<?> getResponse(Object ret) throws JsonParseException, JsonMappingException, IOException {
		...
		JSONObject job = new JSONObject(((UserApiDelegate)ret).getBean());
		return new ResponseEntity<>(getObjectMapper().readValue(job.toString(), User.class), HttpStatus.OK);
	}

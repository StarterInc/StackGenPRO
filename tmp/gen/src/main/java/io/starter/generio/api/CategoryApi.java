...
public interface CategoryApi {
    ...
    CategoryApiDelegate getDelegate();

    @ApiOperation(value = "Delete an Category from the system", nickname = "delete", notes = "Starter Ignite Auto Generated Category:delete", authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = {  })
    @RequestMapping(value = "/Category/{param}",
    ...
    @ApiOperation(value = "Insert a new Category into the system", nickname = "insert", notes = "Starter Ignite Auto Generated Category:insert", response = Category.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Results fetched OK", response = Category.class) })
    @RequestMapping(value = "/Category/{param}",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<Category> insert(@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Category param) {
    ...
    @RequestMapping(value = "/Category/list/{searchparam}",
    ...
    @ApiOperation(value = "Load a Category from the system", nickname = "load", notes = "Starter Ignite Auto Generated Category:load", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    @ApiOperation(value = "Update a Category in the system", nickname = "update", notes = "Starter Ignite Auto Generated Category:update", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    default ResponseEntity<Object> update(@Min(0)@ApiParam(value = "Retreive a single result by ID",required=true) @PathVariable("param") Integer param,@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Category param2) {

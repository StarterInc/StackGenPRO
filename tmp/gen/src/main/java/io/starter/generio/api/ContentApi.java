...
import io.starter.generio.model.Content;
...
public interface ContentApi {
    ...
    ContentApiDelegate getDelegate();

    @ApiOperation(value = "Delete an Content from the system", nickname = "delete", notes = "Starter Ignite Auto Generated Content:delete", authorizations = {
    ...
    @ApiOperation(value = "Insert a new Content into the system", nickname = "insert", notes = "Starter Ignite Auto Generated Content:insert", response = Content.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Results fetched OK", response = Content.class) })
    @RequestMapping(value = "/Content/{param}",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<Content> insert(@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Content param) {
    ...
    @RequestMapping(value = "/Content/list/{searchparam}",
    ...
    @ApiOperation(value = "Load a Content from the system", nickname = "load", notes = "Starter Ignite Auto Generated Content:load", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    @ApiOperation(value = "Update a Content in the system", nickname = "update", notes = "Starter Ignite Auto Generated Content:update", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    default ResponseEntity<Object> update(@Min(0)@ApiParam(value = "Retreive a single result by ID",required=true) @PathVariable("param") Integer param,@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Content param2) {

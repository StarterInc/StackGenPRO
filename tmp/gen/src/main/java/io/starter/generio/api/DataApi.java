...
public interface DataApi {
    ...
    DataApiDelegate getDelegate();

    @ApiOperation(value = "Delete an Data from the system", nickname = "delete", notes = "Starter Ignite Auto Generated Data:delete", authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = {  })
    @RequestMapping(value = "/Data/{param}",
    ...
    @ApiOperation(value = "Insert a new Data into the system", nickname = "insert", notes = "Starter Ignite Auto Generated Data:insert", response = Data.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
            
            })
    }, tags={ "", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Results fetched OK", response = Data.class) })
    @RequestMapping(value = "/Data/{param}",
        produces = { "application/json" }, 
        consumes = { "application/json" },
        method = RequestMethod.POST)
    default ResponseEntity<Data> insert(@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Data param) {
    ...
    @RequestMapping(value = "/Data/list/{searchparam}",
    ...
    @ApiOperation(value = "Load a Data from the system", nickname = "load", notes = "Starter Ignite Auto Generated Data:load", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    @ApiOperation(value = "Update a Data in the system", nickname = "update", notes = "Starter Ignite Auto Generated Data:update", response = Object.class, authorizations = {
        @Authorization(value = "automator_auth", scopes = {
    ...
    default ResponseEntity<Object> update(@Min(0)@ApiParam(value = "Retreive a single result by ID",required=true) @PathVariable("param") Integer param,@ApiParam(value = "Updated JSON data" ,required=true )  @Valid @RequestBody Data param2) {

 ...
 */
public class ApiSpecApiController implements ApiSpecApi {

    
    @org.springframework.beans.factory.annotation.Autowired
    private ApiSpecApiDelegate delegate = null;

	/**
	* No-Args Constructor for classloading.
	*/
	public ApiSpecApiController() {
		// do not use
    }
    
    @org.springframework.beans.factory.annotation.Autowired
    public ApiSpecApiController(ApiSpecApiDelegate delegate) {
        this.delegate = delegate;
    }

    @Override
    public ApiSpecApiDelegate getDelegate() {
        return delegate;
    }
}

...
public class SwaggerDocumentationConfig extends WebSecurityConfigurerAdapter {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
            .title("Simple CSAT API")
            .description("This is the Stripe Simple CSAT API")
            .license("AGPL 3.0")
            .licenseUrl("https://www.gnu.org/licenses/agpl-3.0.html")
            .termsOfServiceUrl("")
            .version("1.0.0")
            .contact(new Contact("","", "colette@stripe.com"))
            .build();
    }
    ...
    public Docket customImplementation(){
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                    .apis(RequestHandlerSelectors.basePackage("io.starter.csat.api"))
                    .build()

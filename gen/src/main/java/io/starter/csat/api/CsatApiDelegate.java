...
/**
 * A delegate to be called by the {@link CsatApiController}}.
...
@EnableWebMvc
public interface CsatApiDelegate {

    Logger log = LoggerFactory.getLogger(CsatApiDelegate.class);
    ...
    public List<CsatApiDelegate> list();
    
    public CsatApiDelegate load();
    ...
    default ResponseEntity<Void> delete( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method CsatApi.delete: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        } else {
            log.warn("ObjectMapper or HttpServletRequest not configured in default CsatApi interface so no example is generated");
        }
     ...
     * @see CsatApi#insert
     */
    default ResponseEntity<Csat> insert( Csat  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				if (ret != null) {
					if (ret instanceof List) {
						return 
						(ResponseEntity<Csat>) getResponse((List<?>) ret);
					} else {
						return 
						(ResponseEntity<Csat>) getResponse((Object) ret);
					}
				} else {
					return new ResponseEntity<>(HttpStatus.NOT_FOUND);
				}
			} catch (Exception e) {
				log.error("Failure running method CsatApi.insert: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
    ...
    default ResponseEntity<List<Object>> list( String  searchparam) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method CsatApi.list: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> load( Integer  param) {
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method CsatApi.load: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
    ...
    default ResponseEntity<Object> update( Integer  param,
        ...
        if(getObjectMapper() != null && getAcceptHeader() != null) {    
			...
			try {
				...
				log.error("Failure running method CsatApi.update: "
						+ e);
				return new ResponseEntity<>(HttpStatus.  INTERNAL_SERVER_ERROR);
			}
        // TODO: implement examples    
	...
	*/
	...
	default ResponseEntity<?> getResponse(Object ret) throws JsonParseException, JsonMappingException, IOException {
		...
		JSONObject job = new JSONObject(((CsatApiDelegate)ret).getBean());
		return new ResponseEntity<>(getObjectMapper().readValue(job.toString(), Csat.class), HttpStatus.OK);
	}
